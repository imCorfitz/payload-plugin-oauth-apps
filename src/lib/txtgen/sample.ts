...
export const addNouns = (ls: string[] = []) => {
  nouns = mergeArray(nouns, ls)
  return nouns.length
}

export const addAdjectives = (ls: string[] = []) => {
  adjectives = mergeArray(adjectives, ls)
  return adjectives.length
}

export const addTemplates = (ls: string[] = []) => {
  sentenceTemplates = mergeArray(sentenceTemplates, ls)
  return sentenceTemplates.length
}

export const setNouns = (ls: string[] = []) => {
  nouns = [...ls].filter((v, i, a) => a.indexOf(v) === i)
  return nouns.length
}

export const setAdjectives = (ls: string[] = []) => {
  adjectives = [...ls].filter((v, i, a) => a.indexOf(v) === i)
  return adjectives.length
}

export const setTemplates = (ls: string[] = []) => {
  sentenceTemplates = [...ls].filter((v, i, a) => a.indexOf(v) === i)
  return sentenceTemplates.length
}
